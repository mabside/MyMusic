...
namespace MyMusic.Services
{
    public class ArtistService : IArtistService
    {
        ...
        public async Task<Artist> CreateArtisit(Artist newArtist)
        {
        ...
        public async Task UpdateArtist(Artist artisitToBeUpdated, Artist artist)
        {
            artisitToBeUpdated.Name = artist.Name;
            await _unitOfWork.CommitAsync();
        }
    }
}
